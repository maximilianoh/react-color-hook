...
export {
  ...
  Compact as CompactPicker,
  Github as GithubPicker,
  Hue as HuePicker,
  Material as MaterialPicker,
  Photoshop as PhotoshopPicker,
  Sketch as SketchPicker,
  Slider as SliderPicker,
  Swatches as SwatchesPicker,
  Twitter as TwitterPicker,
};
